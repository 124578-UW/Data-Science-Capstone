...
# Holdout test patients (excluded from training) - automatically generated by 00_data_cleaning.ipynb
DATA_HOLDOUT = PROJECT_ROOT / "data" / "processed" / "holdout_patients.csv"

HOLDOUT_SEED_ID = 1176294  # Fixed seed patient for holdout selection

N_HOLDOUT = 10  # Total number of holdout patients to select
